...
const bgm = {
  parts: [
    {
      mml: "l4 o5 r16d+2^16 r8d+ d+r16c+8. r16c<g+8. r16a4.^16 r16>c4.^16 r16f+2.^8",
      soundEffect: {
        type: "synth",
        params: [
          {
            Frequency: {
              Start: 261.6,
              ChangeSpeed: 0.5661790311723434,
              ChangeAmount: 0,
            },
            Generator: { Func: "saw", A: 0.6152866998722979 },
            Volume: {
              Attack: 0,
              Sustain: 0.045688926718591,
              Punch: 0.9820864610332266,
              Decay: 0.5102404143219442,
            },
          },
        ],
        volume: 0.08,
    ...
    {
      mml: "l16 o4 rg+g+d+d+8g+g+8 d+8d+8<g+g+g+ g+g+g+g+8>c+8c+8 ccccc+c+c+8 rededed8 f8f8cff e<bbb8b8>f+8 f+<bb>f+8<b8",
      soundEffect: {
        type: "select",
        params: [
          {
            Frequency: { Start: 261.6 },
            Generator: { Func: "saw", A: 0.33507744482138135 },
            Filter: { HP: 0.2 },
            Volume: { Sustain: 0.1969081435345365, Decay: 0.18968390049172656 },
          },
          {
            Frequency: { Start: 261.6 },
            Generator: { Func: "saw", A: 0.16982794952807664 },
            Filter: { HP: 0.2 },
            Volume: { Sustain: 0.1590085107272045, Decay: 0.05073164833028141 },
          },
        ],
        volume: 0.05,
      },
    ...
    },
    {
      ...
      soundEffect: {
        ...
        params: [
          {
            Frequency: {
              Start: 182.30032147427562,
              Slide: -0.5858773166979377,
            },
            Generator: {
              Func: "noise",
              A: 0.282175553143531,
              ASlide: 0.10097406422742039,
            },
            Volume: { Sustain: 0.0898455773456594, Decay: 0.24138066674149147 },
          },
          {
            Frequency: {
              Start: 182.30032147427562,
              Slide: -0.6947734587813665,
            },
            Generator: {
              Func: "saw",
              A: 0.27331175396063173,
              ASlide: 0.3760745043112138,
            },
            Filter: { HP: 0.27027122724574787 },
            Volume: { Sustain: 0.04369639995128299, Decay: 0.2469242844607039 },
          },
        ],
        volume: 0.1,
      },
    ...
    {
      mml: "l16 o4 rcr8.crc rcr8.cr8. cr8.crc rcr8.crc rcr8.crc rcr8.cr8. cr8.crc rcr8.crc",
      soundEffect: {
        type: "hit",
        params: [
          {
            Frequency: {
              Start: 196.35701947760697,
              Slide: -0.5357720710886111,
            },
            Generator: {
              Func: "square",
              A: 0.05470669801689374,
              ASlide: 0.4931778130105645,
            },
            Filter: { HP: 0.24564329135363067 },
            Volume: { Sustain: 0.02282495378116727, Decay: 0.2530352040550288 },
          },
          {
            Frequency: {
              Start: 196.35701947760697,
              Slide: -0.47628104271746263,
            },
            Generator: {
              Func: "square",
              A: 0.36503289322485977,
              ASlide: -0.1725481694267476,
            },
            Filter: { HP: 0.2774174097640015 },
            Volume: { Sustain: 0.006867093315084254, Decay: 0.273132138506773 },
          },
        ],
        volume: 0.1,
      },
